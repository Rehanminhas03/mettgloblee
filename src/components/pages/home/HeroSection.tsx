      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            />
            <span className="text-[10px] sm:text-xs tracking-[0.2em] sm:tracking-[0.3em] uppercase text-primary/80">
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-[10px] sm:text-xs tracking-wider uppercase text-muted-foreground leading-tight">
                  {stat.label}
                </div>
              </motion.div>
            ))}
