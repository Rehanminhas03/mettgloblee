...
const leadership = [
  ...
  },
  {
    ...
    bio: "As CEO of Mett Global, Rehan sets the company's strategic direction and growth plan, combining a technical full-stack background with strategic financial planning. BSCS holder pursuing a Masters in Data Science, with experience leading AI-animated video projects, full-stack platforms, and operational budgeting.",
  ...
  },
  {
    ...
    bio: "As Co-Founder and Managing Director, Ali runs day-to-day operations and our eCommerce and brand-side delivery. He specialises in scaling brands globally on Amazon & eBay, with deep expertise in graphic design, visual storytelling, AI video production, and strategic social media marketing.",
    image: "/team/ali.jpeg",
    linkedin: "",
    twitter: "",
    email: "",
...
const team = [
  {
    ...
    bio: "Junaid focuses on business development and partner relationships, helping the agency expand its footprint with new clients across the region. Background in business operations and technology partnerships.",
  },
  {
    name: "Muhammad Ahmad Aamir",
    role: "Chief Operating Officer (COO)",
    bio: "Muhammad scales operational and execution frameworks across the agency. With international experience across North America and Europe, his focus areas are operational excellence, vendor coordination, and process automation.",
  },
  {
